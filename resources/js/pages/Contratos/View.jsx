            ...
            <div className="container mx-auto px-4 py-8 max-w-5xl">
                ...
                {contrato.estado === 'ACTIVO' && (
                    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-lg font-semibold text-gray-800">Progreso del Contrato</h3>
                            {daysRemaining !== null && (
                        ...
                        <p className="text-xs text-gray-500 mt-1">{progress.toFixed(1)}% completado</p>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900">{contrato.paciente?.email}</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Teléfono</label>
                                <p className="text-gray-900">{contrato.paciente?.telefono || '-'}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-xl font-semibold text-gray-800">Servicio Contratado</h2>
                        </div>
                        <div className="space-y-3">
                            <div>
                                <label className="text-sm text-gray-600">Nombre del Servicio</label>
                                <p className="text-gray-900 font-medium">{contrato.servicio?.nombre}</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Tipo</label>
                                <p className="text-gray-900 capitalize">{contrato.servicio?.tipo_servicio?.replace('_', ' ')}</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Duración</label>
                                <p className="text-gray-900">{contrato.servicio?.duracion_dias} días</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Descripción</label>
                                <p className="text-gray-900 text-sm">{contrato.servicio?.descripcion || '-'}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-xl font-semibold text-gray-800">Fechas</h2>
                        </div>
                        <div className="space-y-3">
                            <div>
                                <label className="text-sm text-gray-600">Fecha de Inicio</label>
                                <p className="text-gray-900 font-medium">{formatDate(contrato.fecha_inicio)}</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Fecha de Fin</label>
                                <p className="text-gray-900 font-medium">{formatDate(contrato.fecha_fin)}</p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Fecha de Creación</label>
                                <p className="text-gray-900">{formatDate(contrato.created_at)}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="text-sm text-gray-600">Costo Contratado</label>
                                <p className="text-3xl font-bold text-gray-900">
                                    ${parseFloat(contrato.costo_contratado).toFixed(2)}
                                </p>
                            </div>
                            <div>
                                <label className="text-sm text-gray-600">Costo Base del Servicio</label>
                ...
                {contrato.observaciones && (
                    <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                        ...
                        <p className="text-gray-700 whitespace-pre-wrap">{contrato.observaciones}</p>
                    </div>
                )}
                ...
                {contrato.planes_alimentacion && contrato.planes_alimentacion.length > 0 && (
                    <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">Planes Alimentarios Vinculados</h2>
                            ...
                            {contrato.planes_alimentacion.map(plan => (
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-blue-600">Ver plan →</span>
                                    </div>
                                </Link>
                            ))}
                        </div>
